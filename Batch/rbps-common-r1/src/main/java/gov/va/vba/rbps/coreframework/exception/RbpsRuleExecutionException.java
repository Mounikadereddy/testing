/*
 * RbpsRuleExecutionException.java
 * 
 ...
 * 
 * <p>
 * Title: <code>RbpsRuleExecutionException</code>
 * </p>
 * <p>
 ...
 * 
 */
public class RbpsRuleExecutionException extends RuntimeException {
	 ...
	 */
	public RbpsRuleExecutionException() {
		super();
	}
	 ...
	 */
	public RbpsRuleExecutionException(String message) {
		super(message);
     ...
     *         unknown.)
     */
	public RbpsRuleExecutionException(Throwable rootCause) {
		super(rootCause);
     ...
     *         unknown.)
     */
	public RbpsRuleExecutionException(String message, Throwable rootCause) {
