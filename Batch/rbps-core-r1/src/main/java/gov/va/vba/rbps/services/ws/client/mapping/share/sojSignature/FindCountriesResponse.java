 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://standarddata.services.vetsnet.vba.va.gov/}cntryTypeDTO" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class FindCountriesResponse {
    ...
    protected List<CntryTypeDTO> _return;
     ...
     * 
     */
    public List<CntryTypeDTO> getReturn() {
        if (_return == null) {
            _return = new ArrayList<CntryTypeDTO>();
        }
        return this._return;
    }
