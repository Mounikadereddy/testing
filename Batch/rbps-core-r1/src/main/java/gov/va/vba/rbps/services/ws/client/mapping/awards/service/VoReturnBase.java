...
@XmlSeeAlso({
    ...
    AwardEventStatusResponse.class,
    ParticipantAwardsResponse.class,
    GAOWorksheetResponse.class,
    AwardResponse.class,
    AwardHistoryResponse.class,
    CurrAndPropAwardResponse.class,
    ProposedAwardResponse.class,
    AwardClaimantResponse.class
})
