...
/**
 * <p>Java class for deathRatingRecord complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="deathRatingRecord">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="numberOfRecords" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="ratings" type="{http://services.share.benefits.vba.va.gov/}deathRating" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "deathRatingRecord", propOrder = {
    "numberOfRecords",
    "ratings",
    "returnCode",
    "returnMessage"
})
public class DeathRatingRecord {

    protected String numberOfRecords;
    @XmlElement(nillable = true)
    protected List<DeathRating> ratings;
     ...
     * 
     */
    public List<DeathRating> getRatings() {
        if (ratings == null) {
            ratings = new ArrayList<DeathRating>();
        }
        return this.ratings;
    }
